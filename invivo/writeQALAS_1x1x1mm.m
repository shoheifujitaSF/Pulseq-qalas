...
sys = mr.opts('MaxGrad', 32, 'GradUnit', 'mT/m', ...
              ...
              'rfDeadTime', 100e-6, ...
              'rfRingdownTime', 60e-6, ...      % GE
              'adcDeadTime', 40e-6, ...         % GE
              'adcRasterTime', 2e-6, ...        % GE
              'gradRasterTime', 20e-6, ...      % GE
              'blockDurationRaster', 20e-6, ... % GE
              'B0', 3.0);      
...
%adc = mr.makeAdc(Nx * os_factor,'Duration',gx.flatTime,'Delay',gx.riseTime,'system',sys);
