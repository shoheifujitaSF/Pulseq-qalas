...
% example nii files are available at:
% https://doi.org/10.5281/zenodo.15045989


img_path = './data/img_qalas.nii';
b1_path = './data/img_b1.nii';
save_filename = 'nist_example';
slice_selection = 29;
...
t2_entries  = [1:2:350, 370:20:1000];

% small dictionary for sanity check
% t1_entries  = [5:100:5000];
% t2_entries  = [1:10:500];
...
figure;imshow(PD_map, [0 max(PD_map(:))]);
figure;imshow(IE_map, [0.7 1]);


save(['./out/',save_filename,'_slice',num2str(slice_selection),'.mat'], 'img', 'img_b1', 'T1_map','T2_map','PD_map','IE_map');